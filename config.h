...
static const unsigned int tagpadding 		= 2;	
static const unsigned int tagspacing 		= 2;	
...
static const char colors[NUMCOLORS][MAXCOLORS][9] = {
	...
	{ "#000000", "#f5f5f5", "#222222" }, // 0 = normal
	//{ "#000000", "#f5f5f5", "#03070b" }, // 0 = normal
	{ "#ff0000", "#f5f5f5", "#005577" }, // 1 = selected
	//{ "#ff0000", "#f5f5f5", "#4b1a2c" }, // 1 = selected
	{ "#b43030", "#f5f5f5", "#b23450" }, // 2 = red / urgent
	{ "#212121", "#f5f5f5", "#464b56" }, // 3 = green / occupied
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL, "-l 2", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,               XK_l,          x_nexttag,      
        {0} }, 
    { MODKEY|ShiftMask,               XK_h,        x_prevtag,      
        {0} },
